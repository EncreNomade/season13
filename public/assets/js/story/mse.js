...
$.extend( mse.ArticleLayer.prototype , {
    ...
    setspeedLevel : function(level) {
        ...
        if(level < 0 || proto.minInv + level*334 > proto.maxInv) return;
...
mse.GameShower.prototype = {
	...
	showResult: function() {
	    ...
	    this.result.children('h2').text(win ? "GAGNE !" : "PERDU !");
...
mse.GameExpose = function(parent, param, game) {
    ...
    if(!this.font) this.font = "16px Gudea";
...
$.extend( mse.GameExpose.prototype , {
    ...
    draw : function(ctx) {
        ...
        if(this.drawResult) {
            ...
            ctx.font = "30px BebasNeueRegular";
            ctx.fillText(this.score, this.scoreleft+this.scorew1, 82);
            // Button restart
            ctx.textAlign = "center";
            ctx.fillStyle = "#666";
