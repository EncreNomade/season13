...
<div>
    ...
    <ul>
        ...
        <li><a href="http://www.furet.com" target="_blank"><?php echo Asset::img('season13/thanks/furet.jpeg', array('alt' => 'Season 13  merci au Furet du nord ')); ?></a></li>
        <li><a href="http://www.lmi-innovation-creation.fr" target="_blank"><?php echo Asset::img('season13/thanks/lmi.jpeg', array('alt' => 'Season 13  merci à LMI')); ?></a></li>
