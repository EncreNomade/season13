...
<head>
    ...
    <title>Bienvenue sur Season13</title>
</head>
    ...
    <table style="width: 100%;height: 100%;" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" >
    	...
    	<div style="position: relative; margin: 0; top: 50px; width: 600px; height: auto;">
    	    ...
    	    <div style="position: relative; float: left; width: 600px; height: 100px; border-bottom: 6px solid rgb(246, 168, 0);">
    	        <?php echo Asset::img('season13/mail/bienvenue_head.jpg', array('style'=>'position: absolute; left: 0px; top: 0px; width: 600px; height: 100px;')); ?>
    	    </div>
    	    ...
    	    <div style="position: relative; float: left; left: 0px; width: 438px; height: auto; padding: 20px 80px; background: #fff; border-left: 1px solid #aaa; border-right: 1px solid #aaa;">
    	        ...
    	        <?php endif; ?>
    	            ...
    	            <p>Puis <a style="color: #000;" href="http://season13.com/games?utm_source=welcome_mail&utm_medium=email">joue à nouveau avec Simon</a> et améliore ton score.</p>
    	            
    	            <a style="position: relative; float: left; left: 0px; width: 220px; height: 50px; margin: 10px 110px 20px 110px; background: rgb(246, 168, 0); border-radius: 10px; border: 2px solid #aaa; text-decoration: none; color: #fff; font: bold 18px/50px sans-serif; text-align: center;" href="http://season13.com/games?utm_source=welcome_mail&utm_medium=email">
    	                L<span style="font-size: 14px;">ES</span> J<span style="font-size: 14px;">EUX</span>
    	            </a>
    	            
    	            <p>N’hésite pas à nous contacter pour toute question, sur la page contact du site ou par mail : contact@encrenomade.com</p>
