<?php
class Controller_Admin_13episodes extends Controller_Admin 
{
	...
	public function action_index()
	{
		...
		$this->template->title = "Admin_13episodes";
		$this->template->content = View::forge('admin/13episodes/index', $data);
	...
	public function action_view($id = null)
	{
		...
		is_null($id) and Response::redirect('Admin_13episodes');

		$this->template->title = "Admin_13episode";
		$this->template->content = View::forge('admin/13episodes/view', $data);
	...
	public function action_create()
	{
		if (Input::method() == 'POST')
		{
			...
			if ($val->run())
			{
				...
				if ($admin_13episode and $admin_13episode->save())
				{
					...
					Response::redirect('admin/13episodes');
				}
		...
		$this->template->title = "Admin_13Episodes";
		$this->template->content = View::forge('admin/13episodes/create');
	...
	public function action_edit($id = null)
	{
		...
		$this->template->title = "Admin_13episodes";
		$this->template->content = View::forge('admin/13episodes/edit');
